	...
	return (
		<Layout>
			<Head>
				...
				<meta
					name='description'
					content='Paga a Meses Sin Intereses, 18 MSI con tarjetas participantes y hasta 24 MSI con Citibanamex. Gran variedad de productos + Entregas EXPRESS CDMX.'
				/>
			</Head>
			<div className={styles.container}>
				...
				<Box component='div' py={2} textAlign='left'>
					...
					<Box component='div' py={2}>
						Cómputo impresión Tintas & tóners Papelería Papel
					</Box>
				</Box>
