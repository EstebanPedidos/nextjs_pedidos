...
export default function ReviewItem({item_num}) {  
  ...
  return (
    <div>      
       <Accordion sx={{boxShadow: '0px 0px 16px rgb(54 85 166 / 8%), 0px 1px 4px rgb(54 85 166 / 8%)'}} expanded={expanded} onChange={()=>{setExpanded((expanded)?false:true)}}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon size="large"/>}
          aria-controls="panel1a-content"
          id="comentarios"          
        >
          <Typography variant="h6" component="h5" >Comentarios</Typography>
        </AccordionSummary>
        <AccordionDetails> 
            <Box component="div"> 
