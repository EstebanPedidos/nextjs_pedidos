...
//     let fechaPedido = localStorage.getItem('fechaPedido');
...
//         MiCuentaService.eliminaFavorito(clienteNum, itemNum).
//         then( response =>{
...
//     useEffect(() => {
//         MiCuentaService.obtieneFavoritosFrecuentes(clienteNum)
//         .then( response =>{
...
//                                 <Button component={Link} variant="contained" color="primary" to="/" size="large" >Comenzar </Button>
//                             </Typography>
//                         </Box>
//                     </Box>
//             </Box>
...
//                             </Grid>
//                             <Grid item xs={6}>
//                                 <Button  type="button" variant="contained" fullWidth size="large" color="primary" disableElevation color="primary" onClick={eliminaFavorito}>Eliminar</Button>
//                             </Grid>
//                             </Grid>
//                         </Box>
//                     </div>
