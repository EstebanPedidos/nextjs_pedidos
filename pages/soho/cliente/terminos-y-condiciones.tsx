				...
				<Grid item xs={12} sm={7} lg={8}>
					<Box component="div" pt={2}>
						...
						<Box component="div" pt={2} >
							...
							<Typography variant='body1' component='p' align='justify'>
								Operadora de Soluciones para Oficina S.A. de C.V. ha establecido la presente política con base a los criterios de aceptación o rechazo de garantías que presentan nuestros proveedores. 
								...
								Requisitos: - Copia de factura legible y anexos de números de serie para componentes de PC&apos;s. <br/>
								- Presentar el producto completo, en su empaque original, accesorios, drivers, manuales, cables, papel, etc. <br/>
								...
								- De forma escrita o verbal deberá detallar lo más específico posible la falla que presenta el producto que se desea ingresar a garantía. <br/>
								- El producto que presenta la falla debe contener el código de barra por parte de Operadora de Soluciones para Oficina S.A. de C.V. adherido al componente para PC.<br/>
								- En caso de cartuchos de tinta y tóner se requiere presentar prueba de impresión defectuosa o carta membretada explicando el problema del producto (requerimiento de proveedores ).<br/>
								- Para cámaras Kodak y equipos de la marca Panasonic es requisito indispensable presentar original de la póliza de garantía. Todo producto que se acepte a garantía está sujeto a la revisión y autorización del fabricante. Se anula la garantía: <br/>
								- Por mal uso, abuso o modificación del equipo por personal no autorizado por Operadora de Soluciones para Oficina S.A. de C.V. (intervención manual en el equipo).<br/>
								- Si el producto presenta el código de barra rayado en el componente. <br/>
								- En los casos que las etiquetas del proveedor sean removidas o alteradas. <br/>
								- Por producto en mal estado (marcas, rayones con plumón indeleble y etiquetas ajenas al código de barras de Operadora de Soluciones para Oficina S.A. de C.V.). <br/>
								- No se aceptan garantías que presenten daño físico entendiendo como tal a: producto quemado, roto, golpeado, intervenido, con resistencias rotas, con sellos de garantía violados, circuitos o soldaduras quemadas o conexiones dañadas. <br/>
								- En caso de Consumibles no se aceptará a garantía ningún producto objeto de una operación reañizada con más de 60días naturales de antiguedad- En caso de cartuchos de tinta y toner que presenten menos del 50% de su contenido. <br/>
								- No hay garantía por rendimiento de cartuchos de tinta y tóner. - Por pixeles quemados en notebooks o monitores con pantalla LCD. Cada marca tiene establecido un mínimo de pixeles quemados para hacer válida la garantía. Restricciones: <br/>
								- Si se recibe el producto incompleto , se pagará de la misma forma hasta que el proveedor lo haga. <br/>
								- Para el caso específico de equipos : monitores, quemadores, DVD&apos;s, CD ROM&apos;S, impresoras, reguladores, no break&apos;s, multifuncionales, faxes, copiadoras, laptop&apos;s, cámaras digitales, máquinas de escribir, video cámaras, iPod&apos;s, escáners, PDA&apos;s, proyectores, notebook&apos;s, teléfonos, MP3, etc., la garantía se tramitará en el centro de servicio respectivo de cada marca, el tiempo de respuesta y reparación dependerá del mismo. <br/>
								- Operadora de Soluciones para Oficina S.A. de C.V. no está obligada a indemnizar al Usuario o a terceras personas por daños directos o indirectos del uso del producto, salvo en los casos establecidos en la Ley Federal de Protección del Consumidor. <br/>
								- Operadora de Soluciones para Oficina S.A. de C.V. no se hace responsable de productos que no se recojan en 3 meses a partir de la fecha de ingreso.<br/>
								 Trámite de garantía: <br/>
								 - Para toda garantía que sea aceptada. Operadora de Soluciones para Oficina S.A. de C.V. entregará un recibo de la garantía al distribuidor mismo que servirá para la reclamación posterior. Sólo se podrá pagar la garantía con el recibo original.<br/>
								- Para todas las garantías que envíen los Usuarios del interior de la República deberá presentarse el paquete en perfectas condiciones, de lo contrario no se recibirá el paquete por la mensajería que se envíe. Tiempo de respuesta: En Componentes de PC&apos;s tenemos 2 tipos de garantías:<br/>
								 Garantía express: <br/>
								 - Para toda garantía que sea aceptada. Operadora de Soluciones para Oficina S.A. de C.V. entregará un recibo de la garantía al distribuidor mismo que servirá para la reclamación posterior. Sólo se podrá pagar la garantía con el recibo original. <br/>
								 - Para todas las garantías que envíen los Usuarios del interior de la República deberá presentarse el paquete en perfectas condiciones, de lo contrario no se recibirá el paquete por la mensajería que se envíe. <br/>
								 - Se tramitará garantía express en productos como: floppy&apos;s, gabinetes, tarjetas madre, modems, mouses, monitores, bocinas, teclados, discos duros, procesadores, CD Roms, dvd&apos;s, combos, memorias, excepto:<br/> 
								 paquetes de software, y equipos como: no break&apos;s, reguladores, impresoras, multifuncionales, fax, artículos de oficina, papelería y muebles. <br/>
								 - Se aplica garantía express en: <br/>
								 Canon (3 meses), HP (1 año) siempre y cuando vengan con su empaque original, y su carta membretada u hoja de impresión. (Requerimiento de proveedores), y las demás marcas están sujetas a la revisión, dictamen y respuesta del proveedor. <br/>
								 - El pago de esta garantía será posterior al diagnóstico. <br/>
								 Garantía normal: <br/>
								 - Si la garantía se presenta dentro de los primeros 30 días de efectuada la compra y cumple con la política, deberá ser pagada en un lapso de 72 hrs. (excepto equipo).<br/>
								- El diagnóstico es de 24 hrs. A partir de su ingreso, después será enviado con el proveedor. <br/>
								- Si la garantía se está presentando después de los 30 días efectuada la compra, se pagará al Usuario entre 7 y 15 días hábiles como máximo. <br/>
								- En productos sobre pedido el tiempo de respuesta dependerá totalmente del proveedor y productos con clave “CE” tendrán garantía a razón del acuerdo pactado en la compra. <br/>
								En Consumibles: <br/>
								- El tiempo de respuesta se sujetará al que otorga cada fabricante ya que depende del mismo el diagnóstico, aprobación y pago de la garantía. <br/>
								- Se aplica garantía express en Canon y HP siempre y cuando vengan con su empaque original, y su carta membretada u hoja de impresión (Requerimiento de proveedor). <br/>
								Forma de pago de garantías: <br/>
								- Cambio físico de la misma forma que ingreso el producto a garantía. <br/>
								- Nota de crédito en caso de que no haya existencia disponible se hará con relación al precio vigente en nuestro sistema dentro de los primeros 30 días de efectuada la compra, después de este plazo se realizará una depreciación a la nota de crédito. <br/>
								- En el caso de muebles de oficina se hacen reparaciones o se sustituyen piezas. No existe garantía en los siguientes productos: Refacciones, cilindros y drums, artículos de limpieza, software e higiénicos. En las siguientes marcas: PANASONIC, FELLOWES, AVERY, MEGAFAX, CINTAS LEXMARK, UNIFAX, LEEDS, MITA, MINOLTA, SHARP, CONSUMIBLES BROTHER, 3M, SOFTWARE Y PAPELES DE TODAS LAS MARCAS. Producto de lento movimiento (LM) y producto de remate (ZD). En la marca ANSEL la garantía se tramita directamente con proveedor.
							</Typography>
						</Box>
