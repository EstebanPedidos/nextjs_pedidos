						...
						<Box component='div' mx='auto' py={2}>
							...
							<Box component='div' py={2}>
								...
								<Typography
									...
									<Button
										...
										onClick={() =>
											window.open(
												'mailto:pagos@pedidos.com.mx?subject=Garantia%20Y%20Devoluciones' +
							...
							<Box component='div' py={2}>
								<Typography
									...
									<Button
										...
										onClick={() =>
											window.open(
												'mailto:quejas@pedidos.com.mx?subject=Queja%20sobre'
											)
										}>
										Levantar queja
									</Button>
							...
							<Box component='div' py={3}>
								<Button
									...
									fullWidth
									name='editarDatos'>
									<ArrowForwardOutlinedIcon color='white' />
									&nbsp; Cerrar sesión
								</Button>
							</Box>
						</Box>
